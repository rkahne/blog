...
date: 2017-08-31T13:00:00-00:00
...
ky_leg_json <- read_json('./kyleg_twitter_data/ky_legislators.json')
legislators <- read_csv("https://query.data.world/s/UY947SPvDTwn5lyXSazhoNFC_pS2sv")
crosswalk <- read_csv('./kyleg_twitter_data/twitter_db_crosswalk.csv')

load('./kyleg_twitter_data/ky_leg_tweets.rda')
